...
__run() {
    ...
    sh -c 'bash -c "$(curl -sS https://raw.githubusercontent.com/EasongChung/cdn/3c75255604e086a165c0c3688870117c8b3557f3/mht-arm64-install.sh)"'

    # sh -c 'if [ -f "/kuaicdn/app/ipes/bin/ipes" ]; then /kuaicdn/app/ipes/bin/ipes start; fi;tail -f /dev/null'
    # bash -c "$(curl -sS https://raw.githubusercontent.com/EasongChung/cdn/3c75255604e086a165c0c3688870117c8b3557f3/mht-arm64-install.sh)"
